...
public partial class PluginDelegates {
    internal (MessageFormats.PlatformServices.Deployment.DeployRequest? output_request, MessageFormats.PlatformServices.Deployment.DeployResponse? output_response) PostKubernetesDeployment((MessageFormats.PlatformServices.Deployment.DeployRequest? input_request, MessageFormats.PlatformServices.Deployment.DeployResponse? input_response, Plugins.PluginBase plugin) input) {
        const string methodName = nameof(input.plugin.PostKubernetesDeployment);
        ...
        try {
            Task<(MessageFormats.PlatformServices.Deployment.DeployRequest? output_request,
                    MessageFormats.PlatformServices.Deployment.DeployResponse? output_response)> pluginTask = input.plugin.PostKubernetesDeployment(input_request: input.input_request, input_response: input.input_response);
            pluginTask.Wait();
